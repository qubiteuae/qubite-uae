export const en = {
  ...
  about: {
    ...
    team: {
      ...
      members: [
        ...
        { name: 'Sen James', role: 'Head of Technology', bio: 'Sen James holds overall responsibility for the technical staff and for operations across all locations.' },
        { name: 'Megha Kumar', role: 'Head of Client Billing / B2B Partner Billing', bio: 'Megha Kumar heads client billing and is responsible for B2B partner billing. This covers the entire invoicing process and the interface communication for our qubite white-label solution.' },
        { name: 'Mohammad Arshad', role: 'Head of Facility — Abu Dhabi', bio: 'Mohammad Arshad runs the operating facility in Abu Dhabi. With his on-site team he monitors the machines in operation around the clock, coordinating maintenance, power management and fault response so customer fleets keep running.' },
        { name: 'Abhijith Reghunath', role: 'Head of Facility — Ras Al Khaimah', bio: 'Abhijith Reghunath runs the operating facility in Ras Al Khaimah. With his on-site team he oversees continuous monitoring, rapid fault response and the day-to-day upkeep of hosted equipment.' },
  ...
  asicMachines: {
    ...
    products: {
      ...
      algorithm: 'Algorithm',
      sort: 'Sort',
      allCategories: 'All Cooling Types',
      ...
      sortOptions: {
        ...
        hashrate: 'Hashrate: High to Low',
        power: 'Power: Low to High',
        efficiency: 'Efficiency: Best First',
      },
